...
ActiveRecord::Schema[8.0].define(version: 2025_04_08_224255) do
  ...
  create_table "entity_names", force: :cascade do |t|
    ...
    t.index ["entity_id"], name: "index_entity_names_on_entity_id"
    t.index ["entity_name_type_id"], name: "index_entity_names_on_entity_name_type_id"
  end
  ...
  create_table "exempla_products", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name", null: false
  end
  ...
  add_foreign_key "entity_names", "entity_name_types"
